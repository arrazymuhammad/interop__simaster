...
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('actions'); ?> 
            <div class="btn-group">
                <a href="<?php echo e(url('admin/perkuliahan/kelas', $kelas->uuid)); ?>/pertemuan" class="btn btn-info"><i
                        class="fa fa-calendar"></i> Data Pertemuan</a>
            </div>
         <?php $__env->endSlot(); ?>
        <dl>
            <dt>Nama Kelas</dt>
...
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('actions'); ?> 
            <a href="<?php echo e(url('admin/perkuliahan/kelas', $kelas->uuid)); ?>/peserta" class="btn btn-info"><i
...
<?php $component->withAttributes([]); ?>
            <?php $__currentLoopData = $list_peserta->sortBy('peserta.nim'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $peserta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo e(url('admin/perkuliahan/kelas/detail-kehadiran', $peserta->uuid)); ?>"
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH D:\web_public\simaster\resources\views/admin/perkuliahan/kelas/show.blade.php ENDPATH**/ ?>