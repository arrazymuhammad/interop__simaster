<x-app page-title="Perkuliahan" extends="datatable">
    <x-component.card title="Detail Kelas Perkuliahan {{ $kelas->nama }}">
        <x-slot name="actions">
            <div class="btn-group">
                <a href="{{ url('admin/perkuliahan/kelas', $kelas->uuid) }}/pertemuan" class="btn btn-info"><i
    ...
    <x-component.card title="Peseta Kelas">
        <x-slot name="actions">
            <a href="{{ url('admin/perkuliahan/kelas', $kelas->uuid) }}/peserta" class="btn btn-info"><i
        ...
        <x-component.table header="NIM|Nama|Persentase Kehadiran" datatable>
            @foreach ($list_peserta->sortBy('peserta.mahasiswa.nim') as $peserta)
                <tr>
                    ...
                    <td>
                        <a href="{{ url('admin/perkuliahan/kelas/detail-kehadiran', $peserta->uuid) }}"
